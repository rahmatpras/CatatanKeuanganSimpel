package luthfikhoirulanwar.catatankeuangan;
...
import luthfikhoirulanwar.catatankeuangan.adapter.NoteAdapter;
import luthfikhoirulanwar.catatankeuangan.db.NoteHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Catatan Keuangan by fi");
